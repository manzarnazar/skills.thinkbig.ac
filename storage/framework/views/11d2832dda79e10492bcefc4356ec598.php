                                ...
                                <?php $__currentLoopData = $section->content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div class="avatar-edit">
                                                                ...
                                                                <small class="mt-2  ">
                                                                    <?php if(@$section->content->images->$imgKey->size): ?>
                                                                        <?php echo app('translator')->get('Recomended size:'); ?>:
                                    ...
                                    <?php else: ?>
                                        <?php if($k != 'images'): ?>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control iconPicker icon"
                                                                autocomplete="off" name="<?php echo e($k); ?>" value="<?php echo e(@$content->data_values->$k); ?>" required>
                                            ...
                                            <?php elseif($item == 'textarea-rich'): ?>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label><?php echo e(__(keyToTitle($k))); ?></label>
                                                        <textarea rows="10" class="form-control trumEdit" name="<?php echo e($k); ?>"><?php echo e(@$content->data_values->$k); ?></textarea>
                                                    </div>
                                                </div>
                                            <?php elseif($k == 'select'): ?>
                                                <?php
                        ...
                        <div class="modal-body">
                            <?php $__currentLoopData = $section->element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($k != 'modal'): ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="image-upload">
                                                    <div class="thumb">
                                                        <div class="avatar-preview">
                                                            <div class="profilePicPreview"
                                                                style="background-image: url(<?php echo e(getImage('/', @$section->element->images->$imgKey->size)); ?>)">
                                                                <button type="button" class="remove-image"><i
                                                                        class="fa fa-times"></i></button>
                                                            </div>
                                                        </div>
                                    ...
                                    <?php elseif($type == 'textarea-rich'): ?>
                                        <div class="form-group">
                                            <label><?php echo e(__(keyToTitle($k))); ?></label>
                                            <textarea rows="4" class="form-control trumEdit" name="<?php echo e($k); ?>"></textarea>
                                        </div>
                                    <?php else: ?>
                                        <div class="form-group">
                                            <label><?php echo e(__(keyToTitle($k))); ?></label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="image-upload">
                                                    <div class="thumb">
                                                        <div class="avatar-preview">
                                                            <div
                                                                class="profilePicPreview imageModalUpdate<?php echo e($loop->index); ?>">
                                                                <button type="button" class="remove-image"><i
                                                                        class="fa fa-times"></i></button>
                                                            </div>
                                                        </div>
        ...
        <?php $__env->startPush('breadcrumb-plugins'); ?>
            <?php if($section->element->modal): ?>
                <a href="javascript:void(0)" class="btn btn-sm btn--primary addBtn"><i
                        class="las la-plus"></i><?php echo app('translator')->get('Add
                            New'); ?></a>
            <?php else: ?>
                <a href="<?php echo e(route('admin.frontend.sections.element', $key)); ?>" class="btn btn-sm btn--primary"><i
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thingpfd/learn.thinkbig.ac/application/resources/views/admin/frontend/index.blade.php ENDPATH**/ ?>