            ...
            <div class="row mx-0">
                <div class="col-xl-7 col-lg-6 px-0 d-none d-lg-block">
                    <div class="login-left-section bg--img">
                        ...
                        <div class="content-wrap">
                            <div class="logo-wrap">
                                <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(getImage(getFilePath('logoIcon') . '/logo.png')); ?>" alt="login-image"></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-5 col-lg-6 px-0">
                    ...
                    <div class="login-box">
                        ...
                        <h4 class="title"><?php echo app('translator')->get('Create Instructor Account'); ?></h4>
                        <form action="<?php echo e(route('instructor.register')); ?>" class="verify-gcaptcha" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="mb-4 form-group">
                                ...
                                <input type="text" class="form--control checkUser" id="username"
                                    placeholder="<?php echo app('translator')->get('Instructor Name'); ?>" name="username" value="<?php echo e(old('username')); ?>" required>
                            </div>
...
<?php endif; ?>
                            ...
                            <div class="social-option">
                                <?php if(
                                    ...
                                    <ul>
                                        <?php if(@$credentials->google?->status == 1): ?>
                                            <li>
                                                <a href="<?php echo e(route('instructor.social.login', 'facebook')); ?>" class="icon">
                                        ...
                                        <?php if(@$credentials->facebook?->status == 1): ?>
                                            <li>
                                                <a href="<?php echo e(route('instructor.social.login', 'google')); ?>" class="icon">
                                        ...
                                        <?php if(@$credentials->linkedin?->status == 1): ?>
                                            <li>
                                                <a href="<?php echo e(route('instructor.social.login', 'Linkedin')); ?>" class="icon">
                                ...
                                <?php endif; ?>
                                <p><?php echo app('translator')->get('Already have an account ? '); ?><a href="<?php echo e(route('instructor.login')); ?>"> <?php echo app('translator')->get('Login'); ?></a></p>
                            </div>
                        </form>
                    </div>
                    <!-- sign in components /> -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?php echo e(route('instructor.login')); ?>" class="btn btn--base btn-sm"><?php echo app('translator')->get('Login'); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thingpfd/skills.thinkbig.ac/application/resources/views/presets/default/instructor/auth/register.blade.php ENDPATH**/ ?>