    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo app('translator')->get('Form Options'); ?></h5>
            ...
            <form class="<?php echo e($formClassName ?? 'generate-form'); ?>">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn--primary btn-global generatorSubmit"><?php echo app('translator')->get('Add'); ?></button>
                </div>
            </form>
        </div>
    </div>
...
<script src="<?php echo e(asset('assets/common/js/form_generator.js')); ?>"></script>
<?php $__env->stopPush(); ?><?php /**PATH /home/thingpfd/learn.thinkbig.ac/application/resources/views/components/form-generator.blade.php ENDPATH**/ ?>