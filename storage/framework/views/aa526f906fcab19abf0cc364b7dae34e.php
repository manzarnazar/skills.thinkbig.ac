                    ...
                    <div class="row">
                                    ...
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="profilePicPreview"
                                                style="background-image: url(<?php echo e(getImage('assets/images/frontend/' . $key .'/'. @$data->data_values->$imgKey,@$section->element->images->$imgKey->size)); ?>)">
                                        ...
                                        <div class="avatar-edit">
                                            <input type="file" class="profilePicUpload"
                                                ...
                                                id="profilePicUpload<?php echo e($loop->index); ?>" accept=".png, .jpg, .jpeg">
                                            ...
                                            <small class="mt-2">
                                                ...
                                                | <?php echo app('translator')->get('Recommended size'); ?>:
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea rows="10" class="form-control" name="<?php echo e($k); ?>"
                                    required><?php echo e(@$data->data_values->$k); ?></textarea>
                            </div>
                        </div>

                        <?php elseif($content == 'textarea-rich'): ?>

                        <div class="col-md-12">
                            <div class="form-group">
                                <label><?php echo e(__(keyToTitle($k))); ?></label>
                                <textarea rows="10" class="form-control trumEdit"
                                    name="<?php echo e($k); ?>"><?php echo e(@$data->data_values->$k); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="<?php echo e(@$selectName); ?>" required>
                                    ...
                                    <option value="<?php echo e($selectItemKey); ?>" <?php if(@$data->data_values->$selectName ==
                                        $selectItemKey): ?> selected <?php endif; ?>><?php echo e(__($selectOption)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thingpfd/learn.thinkbig.ac/application/resources/views/admin/frontend/element.blade.php ENDPATH**/ ?>